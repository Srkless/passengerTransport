...
public:
	...
	void writeReport(const std::string& fileName, const Report& report) const; /// sve ok
	void writeProblemReport(const std::string& fileName, const ProblemReport& report) const;	// problemi
